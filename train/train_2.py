...
cfg.load_from = './work_dirs/segformer_modelA/iter_53550.pth'


# Set up working dir to save files and logs.
cfg.work_dir = './work_dirs/segformer_modelB'

cfg.train_cfg.max_iters = 35700
cfg.train_cfg.val_interval = 3570
cfg.default_hooks.logger.interval = 1000
cfg.default_hooks.checkpoint.interval = 3570
