...
# # 전체 데이터셋으로 할 때는 주석처리하기 - Splits 폴더 만들고 train/val 나눈 정보 .txt 파일로 저장
...
cfg.train_cfg.max_iters = 40000 #160000 #20000 // 총 iterations
cfg.train_cfg.val_interval = 5000 #200. // validation 하는 간격
cfg.default_hooks.logger.interval = 5000 #10 # 로그 찍는 간격
